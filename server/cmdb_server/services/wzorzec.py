...
WZORCE: dict[str, list[dict]] = {
    "rodzaj": [
        ...
        {"klucz": "klucz_rodzaju", "etykieta": "Klucz", "typ": "tekst",
         "wymagane": True, "grupa": "Tożsamość",
         "podpowiedz": "małe litery bez spacji, np. projektor"},
        {"klucz": "opis", "etykieta": "Do czego służy", "typ": "notatka",
         "grupa": "Tożsamość"},
    ],
    "osoba": [
        {"klucz": "imie_nazwisko", "etykieta": "Imię i nazwisko", "typ": "tekst",
         "wymagane": True, "w_etykiecie": True, "grupa": "Tożsamość"},
        ...
        {"klucz": "dzial", "etykieta": "Dział", "typ": "odwolanie", "cel": "dzial",
         "grupa": "Organizacja"},
        {"klucz": "lokalizacja", "etykieta": "Lokalizacja", "typ": "odwolanie",
         "cel": "lokalizacja", "rola": "lokalizacja_osoby", "grupa": "Organizacja"},
        {"klucz": "stanowisko", "etykieta": "Stanowisko", "typ": "tekst",
         "grupa": "Organizacja"},
        {"klucz": "notatki", "etykieta": "Notatki", "typ": "notatka", "grupa": "Pozostałe"},
    ],
    "dzial": [
        {"klucz": "nazwa_dzialu", "etykieta": "Dział", "typ": "tekst",
         "wymagane": True, "w_etykiecie": True, "grupa": "Tożsamość",
         "podpowiedz": "np. Infrastruktura IT"},
        {"klucz": "skrot", "etykieta": "Skrót", "typ": "tekst", "grupa": "Tożsamość",
         "podpowiedz": "np. IT", "w_etykiecie": True},
        {"klucz": "dzial_nadrzedny", "etykieta": "Dział nadrzędny", "typ": "odwolanie",
         "cel": "dzial", "grupa": "Struktura"},
        {"klucz": "kierownik", "etykieta": "Kierownik", "typ": "odwolanie",
         "cel": "osoba", "rola": "kierownik", "grupa": "Struktura"},
        {"klucz": "centrum_kosztow", "etykieta": "Centrum kosztów", "typ": "tekst",
         "grupa": "Rozliczenia"},
    ],
    "lokalizacja": [
    ...
    "dostawca": [
        ...
        {"klucz": "nip", "etykieta": "NIP", "typ": "tekst", "format": "nip",
         "grupa": "Tożsamość", "podpowiedz": "10 cyfr", "w_etykiecie": True},
        {"klucz": "kanal_zgloszen", "etykieta": "Sposób kontaktu", "typ": "wybor",
         "wymagane": True, "opcje": ["portal", "e-mail", "telefon", "serwis u nas"],
         "rola": "kanal_zgloszen", "grupa": "Zgłoszenia"},
        {"klucz": "email_zgloszen", "etykieta": "Adres zgłoszeń", "typ": "tekst",
         "format": "email", "rola": "email_zgloszen", "grupa": "Zgłoszenia",
         "podpowiedz": "serwis@dostawca.pl"},
        {"klucz": "portal_zgloszen", "etykieta": "Portal zgłoszeń", "typ": "tekst",
         "format": "url", "grupa": "Zgłoszenia"},
        {"klucz": "telefon_wsparcia", "etykieta": "Telefon wsparcia", "typ": "tekst",
         "format": "telefon", "rola": "telefon_wsparcia", "grupa": "Zgłoszenia"},
        {"klucz": "godziny_wsparcia", "etykieta": "Godziny wsparcia", "typ": "tekst",
         "format": "godziny", "grupa": "Zgłoszenia", "podpowiedz": "pn-pt 8:00-17:00"},
        {"klucz": "czas_reakcji_h", "etykieta": "Czas reakcji (godz.)", "typ": "liczba",
         "min": 1, "max": 720, "grupa": "Zgłoszenia"},
...
POLA_RODZAJU: dict[str, list[dict]] = {
    "monitor": [
        {"klucz": "przekatna_cale", "etykieta": "Przekątna (cale)", "typ": "liczba",
         "min": 5, "max": 120, "grupa": "Parametry"},
        {"klucz": "rozdzielczosc", "etykieta": "Rozdzielczość", "typ": "tekst",
         "grupa": "Parametry", "podpowiedz": "2560x1440"},
        {"klucz": "zlacza", "etykieta": "Złącza", "typ": "tekst",
    ...
    "telefon": [
        {"klucz": "imei", "etykieta": "IMEI", "typ": "tekst", "grupa": "Tożsamość"},
